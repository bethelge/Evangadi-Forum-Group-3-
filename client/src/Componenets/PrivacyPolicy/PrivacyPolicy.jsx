  ...
  return (
    <>
      ...
      <div className="container mt-5">
        ...
        <h3 className={classes.h3}>Privacy Policy of evangadi.com</h3>
        <p className={classes.p}>
          ...
          any other services we offer. By using our services, you consent to the
          collection and other use of your information as described below. This
          Privacy Policy may be updated as we continue improving evangadi.com.
        </p>

        <h3 className={classes.h3}>What information do we collect?</h3>
        <p className={classes.p}>
          We collect information from you when you register on our site or
          subscribe to our newsletter. When registering on our site, you may be
          asked to enter your name, user ID, or e-mail address. You may,
          however, visit our site anonymously. If you use Facebook or Google
          accounts to register, we collect the public information you allow us
          to receive.
        </p>
        ...
        <h3 className={classes.h3}>What do we use your information for?</h3>
        <p className={classes.p}>
          Any of the information we collect from you may be used in one of the
          following ways:
        </p>
        <p className={classes.p}>
          <span className={classes.h3}>Personalize your experience:</span>
        ...
        <p className={classes.p}>
          <span className={classes.h3}>Improve our Services:</span> We
          continually strive to improve our website offerings based on the
          information and feedback we receive from you,
        </p>
        <p className={classes.p}>
          <span className={classes.h3}>Send you messages:</span> We may use the
          email address you may provide on registration to send periodical
          updates as part of our service and notify you of important
          developments regarding the service. The email address you provide may
          be used to send you information, respond to inquiries, and/or other
        ...
        <h3 className={classes.h3}>How is this information shared?</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>How do we protect your information?</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Do we use cookies?</h3>
        <p className={classes.p}>
        ...
        <p className={classes.p}>
          You can delete your account anytime. However, posts, comments, and
          messages you submit may still be viewable or available on our servers.
        </p>
        ...
        <h3 className={classes.h3}>Third-party links</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Online Privacy Policy Only</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Your Consent</h3>
        <p className={classes.p}>
        ...
        <p className={classes.p}>
          This policy was last modified on <strong>Sept 26, 2019</strong>.
        </p>
