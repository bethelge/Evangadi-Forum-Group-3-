  ...
  return (
    <>
      ...
      <div className="container mt-5">
        <h1 className={classes.h1}>Terms and Conditions</h1>
        <h3 className={classes.h3}>Terms and Conditions of evangadi.com</h3>
        <p className={classes.p}>Effective Sept 26, 2019</p>
        ...
        <h3 className={classes.h3}>Acceptance of Terms.</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Terminologies</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Eligibility and Access</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Termination</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Content</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>User Content</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Rights Associated with the Service</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Use of the Service</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Copyright, DMCA and takedowns</h3>
        <p className={classes.p}>
          ...
          formatted DMCA request (see 17 U.S.C.§ 512) to evangadi.com.
        </p>
        <p className={classes.p}>
        ...
        <p className={classes.p}>
          Copyright Agent c/o DMCA 1812 Metzerott RD #37 Adelphi, MD 20783
        </p>
        <p className={classes.p}>
        ...
        <p className={classes.p}>
          If you believe User Content was wrongly removed from evangadi.com due
          to a DMCA request, you may request a copy of the DMCA notice and you
          may file a counter-notification by sending us the following:
        </p>
        ...
        <p className={classes.p}>
          ...
          <Link to="/terms" className={classes.termsLink}>
            evangadi.com/legal/terms/
          </Link>
          .
        </p>
        <h3 className={classes.h3}>Disclaimers</h3>
        <p className={classes.p}>
        ...
        <p className={classes.p}>
          ...
          EVANGADI.COM OR THROUGH THE SITE, SERVICES, EVANGADI.COM CONTENT OR
          USER CONTENT, WILL CREATE ANY WARRANTY NOT EXPRESSLY MADE HEREIN.
        </p>

        <h3 className={classes.h3}>EARNINGS DISCLAIMER</h3>
        <p className={classes.p}>
          ...
          the programing skills we teach you.
        </p>

        <p className={classes.p}>
          We just want to help by teaching the skills to help you join the
          coding world. You should know that all products and services by our
          company are for educational and informational purposes only. Nothing
          on this page, any of our Sites, or any of our content or curriculum is
          a promise or guarantee of results or future earnings, and we do not
        ...
        <p className={classes.p}>
          ...
          events, services, or Sites, should be done only with the knowledge
          that you could experience risk or losses just like any educational
          endeavor. Use caution and always consult your accountant, lawyer or
          professional advisor before acting on this. You alone are responsible
          and accountable for your decisions, actions and results in life, and
          by your registration here you agree not to attempt to hold us liable
          for your decisions, actions or results, at any time, under any
          circumstance.
        </p>

        <h3 className={classes.h3}>Indemnity</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Governing Law and Jurisdiction</h3>
        <p className={classes.p}>
        ...
        <h3 className={classes.h3}>Modification</h3>
        <p className={classes.p}>
